...
-- Full operational access for authenticated, service_role, postgres & anon
-- =====================================================
...
CREATE POLICY "Allow all full access to ai_agent_tasks"
...
CREATE POLICY "Allow all full access to ai_agent_sessions"
...
CREATE POLICY "Allow all full access to agent_execution_logs"
...
CREATE POLICY "Allow all full access to agent_execution_steps"
...
CREATE POLICY "Allow all full access to agent_execution_events"
...
GRANT ALL ON TABLE public.ai_agent_tasks TO authenticated, service_role, postgres, anon;
GRANT ALL ON TABLE public.ai_agent_sessions TO authenticated, service_role, postgres, anon;
GRANT ALL ON TABLE public.agent_execution_logs TO authenticated, service_role, postgres, anon;
GRANT ALL ON TABLE public.agent_execution_steps TO authenticated, service_role, postgres, anon;
GRANT ALL ON TABLE public.agent_execution_events TO authenticated, service_role, postgres, anon;
