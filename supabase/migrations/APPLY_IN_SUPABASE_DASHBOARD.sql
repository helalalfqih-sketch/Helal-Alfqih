...
-- =======================================================
-- 7. AI AGENT EXECUTION PERSISTENCE LAYER
-- =======================================================
...
CREATE POLICY "admin read execution logs" ON public.agent_execution_logs FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "admin read execution events" ON public.agent_execution_events;
CREATE POLICY "admin read execution events" ON public.agent_execution_events FOR ALL USING (true) WITH CHECK (true);
