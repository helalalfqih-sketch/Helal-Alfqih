  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div 
        ...
        className="bg-[#0F0C1B] border border-gray-800 rounded-[32px] w-full max-w-lg p-6 sm:p-8 relative shadow-2xl max-h-[90vh] overflow-y-auto no-scrollbar"
      >
        {/* Header */}
        ...
        <form onSubmit={handleSearch} className="space-y-3 mb-6">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#151025] border border-gray-800 rounded-xl px-4 py-2.5 text-sm text-white uppercase outline-none focus:border-[#7B3FFF]"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#151025] border border-gray-800 rounded-xl px-4 py-2.5 text-sm text-white outline-none focus:border-[#7B3FFF] dir-ltr text-right"
            />
          </div>
        ...
        {searched && (
          <div>
            {foundOrder ? (
              <div className="bg-[#151025] p-5 rounded-2xl border border-gray-800 space-y-4">
                ...
                <div className="bg-[#0F0C1B] p-3 rounded-xl border border-gray-800/80">
                  <span className="text-xs text-gray-400 block mb-1">حالة الطلب الحالية:</span>
                  <span className="text-[#7B3FFF] font-bold text-sm">
                        ...
                        <div key={step.key} className="flex items-center gap-3">
                          <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold border transition-all ${
                              isCompleted
                                ? 'bg-[#7B3FFF] border-[#7B3FFF] text-white glow-neon'
                                : 'bg-[#1F1545] border-gray-800 text-gray-500'
                            }`}
                          >
              ...
              <div className="bg-[#151025] p-6 rounded-2xl border border-gray-800 text-center text-gray-400 text-xs space-y-2">
                ...
                <div className="pt-2">
                  <p className="text-[#7B3FFF] font-semibold mb-2">طلبات تجريبية متوفرة للاختبار:</p>
                  <div className="flex justify-center gap-2 flex-wrap">
                    <button
                      ...
                      className="bg-[#1F1545] hover:bg-[#7B3FFF] text-white px-3 py-1 rounded-lg border border-[#7B3FFF]/30 transition-colors"
                    >
                      جرب طلب IND-8921
                    </button>
                    <button
