...
import { MessageCircle, MapPin, Truck, Package, Facebook, Instagram, PhoneCall, ShieldCheck } from 'lucide-react';
...
export const StoreFooter: React.FC<StoreFooterProps> = ({ onOpenTracker, onOpenAdmin }) => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-gray-500 text-xs dir-rtl border-t border-[var(--color-border-subtle)] pt-4">
        <div>
        ...
        {onOpenAdmin && (
          <button
            onClick={onOpenAdmin}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-purple-900/30 hover:bg-purple-800/50 border border-purple-500/30 text-purple-300 font-bold text-xs transition-all cursor-pointer"
          >
