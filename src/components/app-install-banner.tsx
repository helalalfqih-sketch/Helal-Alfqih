    ...
    <>
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 text-white">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl bg-primary px-3 py-1.5 text-xs font-bold text-white shadow-brand hover:bg-primary/90 transition active:scale-95 shrink-0 min-h-[44px]"
            >
      ...
      {typeof document !== "undefined" &&
        ...
        createPortal(
          ...
          >
            <div
              className="relative w-full max-w-md overflow-hidden rounded-3xl border border-white/15 bg-[#0c1a29] p-6 text-start shadow-2xl space-y-5"
              dir="rtl"
            >
              <button
                type="button"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-cyan-400 font-semibold">
                    خطوات بسيطة بدون الحاجة لـ المتجر
                  </p>
                </div>
              </div>
              ...
              {isIos ? (
                ...
                <div className="space-y-3 rounded-2xl bg-white/5 p-4 border border-white/10 text-xs">
                  <p className="font-bold text-white mb-2 flex items-center gap-1.5">
                    <Smartphone className="h-4 w-4 text-cyan-400" /> خطوات التثبيت على آيفون
                    (Safari):
                  </p>
                  <ol className="space-y-2 text-slate-300">
                    <li className="flex items-start gap-2">
                      <span className="grid h-5 w-5 shrink-0 place-items-center rounded-full bg-primary/20 text-[11px] font-bold text-cyan-300">
                        1
                      </span>
                      <span>
                        اضغط على زر **المشاركة** (
                        <Share className="inline h-3.5 w-3.5 text-cyan-400" />) في شريط Safari
                        السفلي.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <PlusSquare className="inline h-3.5 w-3.5 text-cyan-400" /> Add to Home
                        Screen).
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        اضغط على **إضافة (Add)** في أعلى اليمين لتثبيت الأيقونة على الشاشة الرئيسية.
                      </span>
                    </li>
                  </ol>
                </div>
                ...
                <div className="space-y-3 rounded-2xl bg-white/5 p-4 border border-white/10 text-xs">
                  <p className="font-bold text-white mb-2 flex items-center gap-1.5">
                    <Smartphone className="h-4 w-4 text-cyan-400" /> خطوات التثبيت على أندرويد
                    (Chrome):
                  </p>
                  <ol className="space-y-2 text-slate-300">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        اضغط على زر خيارات المتصفح (
                        <MoreVertical className="inline h-3.5 w-3.5 text-cyan-400" /> ثلاث نقاط) في
                        أعلى الشاشة.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        اختر <strong>إضافة إلى الشاشة الرئيسية</strong> أو{" "}
                        <strong>تثبيت التطبيق</strong> (Install app).
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="grid h-5 w-5 shrink-0 place-items-center rounded-full bg-primary/20 text-[11px] font-bold text-cyan-300">
