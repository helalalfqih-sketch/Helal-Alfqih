  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div 
        ...
        className="bg-[#0F0C1B] border border-gray-800 rounded-[32px] w-full max-w-lg max-h-[90vh] overflow-y-auto no-scrollbar p-6 sm:p-8 relative shadow-2xl"
      >
        {/* Header */}
        ...
        {placedOrder ? (
          ...
          <div className="text-center py-6 space-y-5">
            ...
            <div className="bg-[#151025] p-4 rounded-2xl border border-gray-800 text-right text-xs space-y-2 text-gray-300">
              <p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-right">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#151025] border border-gray-800 rounded-xl px-4 py-3 text-sm text-white focus:border-[#7B3FFF] outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#151025] border border-gray-800 rounded-xl px-4 py-3 text-sm text-white focus:border-[#7B3FFF] outline-none dir-ltr text-right"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-[#151025] border border-gray-800 rounded-xl px-4 py-3 text-sm text-white focus:border-[#7B3FFF] outline-none cursor-pointer"
              >
                {STORE_INFO.governorates.map((gov) => (
                  <option key={gov} value={gov} className="bg-[#0F0C1B] text-white">
                    {gov}
                  </option>
                ))}
              </select>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-[#151025] border border-gray-800 rounded-xl px-4 py-2.5 text-sm text-white focus:border-[#7B3FFF] outline-none"
              />
            </div>
                ...
                <button
                  ...
                  className={`p-3 rounded-xl border text-right transition-all flex flex-col gap-1 cursor-pointer ${
                    paymentMethod === 'cash'
                      ...
                      : 'border-gray-800 bg-[#151025] text-gray-400'
                  }`}
                >
            ...
            {/* Total Summary */}
            <div className="bg-[#151025] p-3.5 rounded-2xl border border-gray-800 flex justify-between items-center text-sm font-bold text-white mt-4">
