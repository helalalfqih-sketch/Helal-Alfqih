...
import { X, Check, ArrowLeftRight, ShoppingCart, Trash2, Star } from 'lucide-react';
          ...
          <div className="p-4 sm:p-6 border-b border-white/10 flex items-center justify-between bg-[#12151a]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#A7ADB7]">قارن بين المنتجات المحددة لاختيار الأنسب لمتطلباتك</p>
              </div>
            </div>
            ...
            {compareList.length === 0 ? (
              ...
              <div className="min-w-[600px] grid grid-cols-1 md:grid-cols-3 gap-4">
                {compareList.map((product) => (
                  <div
                    key={product.id}
                    className="bg-[#12151a] border border-white/10 rounded-2xl p-4 flex flex-col justify-between space-y-4 relative group hover:border-blue-500/40 transition-colors"
                  >
                    {/* Remove button */}
                    <button
                    ...
                    <button
                      ...
                      className="w-full bg-[#2F6BFF] hover:bg-[#2458D8] text-white text-xs font-bold py-2.5 rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-blue-600/20"
                    >
