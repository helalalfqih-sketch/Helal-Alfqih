  ...
  return (
    <div className="px-3 sm:px-6 py-2">
      <motion.div 
        ...
        className="relative overflow-hidden flex flex-col gap-2.5 border border-[var(--color-border-default)] rounded-2xl px-4 py-3 bg-[var(--color-surface-1)] backdrop-blur-md hover:border-[var(--color-border-strong)] transition-all cursor-pointer group shadow-sm"
      >
        {/* Line 1 */}
        <div className="flex items-center justify-between text-xs sm:text-sm text-[var(--color-text-secondary)] relative z-10">
