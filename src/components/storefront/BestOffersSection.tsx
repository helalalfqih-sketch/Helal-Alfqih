...
export const BestOffersSection: React.FC<BestOffersSectionProps> = ({
  ...
  return (
    <section className="py-3 relative select-none">
      ...
      <div className="relative group/scroll">
        ...
        <div
          ...
          className={`px-4 sm:px-8 flex gap-3 sm:gap-4 overflow-x-auto no-scrollbar snap-x pb-3 pt-1 touch-pan-x cursor-grab ${
