...
import { Zap, WifiOff, Check, X, ShieldAlert } from "lucide-react";
import { useLiteMode, LiteModeSetting } from "./liteMode";
  ...
  return (
    <>
      {variant === "badge" ? (
        ...
        >
          <Zap
            className={`w-3.5 h-3.5 ${isActive ? "text-amber-400 fill-amber-400/20 animate-pulse" : "text-gray-400"}`}
          />
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h4 className="text-sm font-bold text-[var(--color-text-primary)]">
                  الوضع الخفيف (Lite Mode)
                </h4>
                <p className="text-[11px] text-[var(--color-text-secondary)]">
                  لتسريع التصفح وتوفير بيانات الإنترنت والشبكات الضعيفة
                </p>
              </div>
            </div>
            <span
              className={`text-xs px-2.5 py-1 rounded-full font-bold border ${isActive ? "bg-amber-500/20 text-amber-400 border-amber-500/40" : "bg-gray-800 text-gray-400 border-gray-700"}`}
            >
            ...
            >
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[var(--color-text-primary)]">
                      إعدادات الوضع الخفيف
                    </h3>
                    <p className="text-xs text-[var(--color-text-secondary)]">
                      تحسين سرعة التصفح وتوفير البيانات
                    </p>
                  </div>
                </div>
              ...
              <div className="p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/30 mb-5 text-xs text-amber-200/90 leading-relaxed flex items-start gap-2.5">
                ...
                <div>
                  ...
                  يقلل استهلاك الإنترنت، يستبدل العرض ثلاثي الأبعاد بصور خفيفة سريعة التحميل، ويعمل
                  بسلاسة فائقة حتى مع ضعف التغطية.
                </div>
              </div>
                ...
                >
                  <div>
                    <div className="font-bold text-sm text-[var(--color-text-primary)] flex items-center gap-2">
                      ...
                      {pref === "auto" && (
                        <span className="text-[10px] bg-[#2F6BFF] text-white px-2 py-0.5 rounded-full font-bold">
                          الموصى به
                        </span>
                      )}
                    </div>
