...
export const StoreLogo: React.FC<StoreLogoProps> = ({ variant = "header", className = "" }) => {
  if (variant === "icon") {
    return (
      <div
        className={`relative flex items-center justify-center rounded-2xl bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#090D16] border border-[#2F6BFF]/40 p-2 shadow-lg shadow-blue-500/10 ${className}`}
      >
        <svg
          viewBox="0 0 100 100"
        ...
        >
          ...
          {/* Shopping Cart & Stylized Letter I/S */}
          <path
  ...
  if (variant === "badge") {
    return (
      <div
        className={`relative flex items-center gap-3 bg-gradient-to-r from-slate-900/90 via-slate-800/90 to-slate-900/90 border border-[#2F6BFF]/40 p-3 rounded-2xl shadow-xl dir-rtl ${className}`}
      >
        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#0F172A] to-[#1E293B] border border-[#2F6BFF]/50 p-1.5 shrink-0 flex items-center justify-center shadow-md">
          <svg
            viewBox="0 0 100 100"
            className="w-full h-full"
            fill="none"
        ...
        <div className="flex flex-col text-right">
          <span className="text-white font-black text-base tracking-wide leading-tight">
            INDEXES <span className="text-[#2F6BFF]">STORE</span>
          </span>
          <span className="text-[#FFB800] text-[11px] font-bold">متجر إندكس | الجودة والفخامة</span>
        </div>
      </div>
    );
  }
  ...
  if (variant === "full") {
    return (
      <div className={`flex flex-col items-center justify-center text-center ${className}`}>
        <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-3xl bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#0B0F19] border-2 border-[#2F6BFF]/60 p-3 shadow-2xl shadow-blue-500/20 mb-3 flex items-center justify-center">
          <svg
            viewBox="0 0 100 100"
            className="w-full h-full"
            fill="none"
  ...
  return (
    <div className={`flex items-center gap-2 select-none cursor-pointer dir-rtl ${className}`}>
      <div className="relative w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-br from-[#0F172A] to-[#1E293B] border border-[#2F6BFF]/50 p-1 shrink-0 flex items-center justify-center shadow-md shadow-blue-600/15 group-hover:border-[#2F6BFF] transition-all">
        <svg
          viewBox="0 0 100 100"
          className="w-full h-full"
          fill="none"
      ...
      <div className="hidden lg:flex flex-col text-right">
        ...
        <span className="text-[9px] font-bold text-[#FFB800] leading-tight mt-0.5">متجر إندكس</span>
      </div>
    </div>
  );
};
