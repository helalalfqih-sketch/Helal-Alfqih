...
interface ComponentLayer {
  ...
  type: 'glass' | 'display' | 'case' | 'gasket' | 'motherboard' | 'battery' | 'speaker' | 'sensor' | 'silicone' | 'liquid';
  color: string;
  icon: string;
}

export type CategoryType = 'speaker' | 'audio' | 'smartwatches' | 'perfumes' | 'appliance' | 'generic';
...
export const CinematicProductDeconstruction: React.FC<CinematicProps> = ({
  ...
  const [cameraView, setCameraView] = useState<'orbit' | 'exploded' | 'macro' | 'assembled'>('orbit');
  ...
  const currentPhase = useMemo(() => {
    ...
    if (currentTime < 17)
      return { titleAr: 'المرحلة 3: المسح الماكرو والدقة الداخلية', progress: (currentTime - 12) / 5 };
    if (currentTime < 20)
      return { titleAr: 'المرحلة 4: العرض الكلي المكتمل للأجزاء', progress: (currentTime - 17) / 3 };
  ...
  return (
    <div
      className={`relative w-full bg-[#05040A] text-white overflow-hidden rounded-[24px] sm:rounded-[32px] border border-white/10 shadow-2xl flex flex-col justify-between select-none ${
        isFullscreen ? 'fixed inset-0 z-50 rounded-none border-none' : 'max-h-[96vh] overflow-y-auto'
      }`}
      dir="rtl"
    >
      {/* 1. TOP HEADER BAR */}
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-tr from-[#7B3FFF] to-[#38BDF8] p-[1px] shadow-lg shadow-purple-500/20 shrink-0">
            <div className="w-full h-full bg-[#0B0818] rounded-[15px] flex items-center justify-center">
              <Crosshair className="w-4 h-4 sm:w-5 sm:h-5 text-[#38BDF8] animate-spin" style={{ animationDuration: '12s' }} />
            </div>
          </div>
                    ...
                    >
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          ...
                          {layer.type === 'case' && (
                            ...
                            >
                              ...
                              <div className="text-center my-auto">
                                <span className="text-xs font-black text-amber-100">ACOUSTIC ENCLOSURE</span>
                                <span className="text-[8px] font-mono text-amber-300 block">RESONANCE DAMPED</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'glass' && (
                            ...
                            >
                              <div className="w-[180px] h-[180px] rounded-full border-2 border-dashed border-cyan-300 flex flex-col items-center justify-center text-center">
                                ...
                                <span className="text-[9px] font-black text-cyan-100">360° RGB LED RING</span>
                                <span className="text-[7px] font-mono text-cyan-200">MUSIC SYNC</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'speaker' && (
                            ...
                            >
                              <div className="w-[160px] h-[160px] rounded-full border-4 border-zinc-800 bg-gradient-to-b from-zinc-900 to-black flex flex-col items-center justify-center text-center">
                                ...
                                <span className="text-[10px] font-black text-white">45W SUBWOOFER</span>
                                <span className="text-[7px] font-mono text-red-300">N52 NEODYMIUM</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'motherboard' && (
                            ...
                            >
                              ...
                              <span className="text-[9px] font-black text-emerald-300 text-center">DSP & BLUETOOTH 5.3</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'battery' && (
                            ...
                            >
                              ...
                              <span className="text-[7px] font-mono text-purple-300">POWER BANK OUT</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'gasket' && (
                            ...
                            >
                              <div className="w-[150px] h-[150px] rounded-full border-2 border-pink-500/50 flex flex-col items-center justify-center text-center">
                                ...
                                <span className="text-[8px] font-black text-pink-300">PASSIVE RADIATOR</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'sensor' && (
                            ...
                            >
                              <span className="text-[9px] font-black text-zinc-300">ANTI-VIBRATION SILICONE BASE</span>
                            </div>
                          )}
                        </div>
                      )}
                          ...
                          {layer.type === 'silicone' && (
                            ...
                            >
                              <div className="w-20 h-20 rounded-full border-2 border-cyan-200/60 bg-black/50 flex flex-col items-center justify-center text-center p-1">
                                <span className="text-[9px] font-black text-cyan-200">SILICONE TIP</span>
                                <span className="text-[7px] font-mono text-cyan-300">30dB ISOLATION</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'case' && (
                            ...
                            >
                              <div className="w-[185px] h-[185px] rounded-full bg-[#080712] border border-white/20 flex flex-col items-center justify-center text-center p-3">
                                <span className="text-[10px] font-black text-zinc-200">ACOUSTIC CHAMBER</span>
                                <span className="text-[8px] font-mono text-cyan-400">POLYCARBONATE SHELL</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'speaker' && (
                            ...
                            >
                              <div className="w-[145px] h-[145px] rounded-full border-4 border-amber-400/80 bg-zinc-950 flex flex-col items-center justify-center text-center">
                                ...
                                <span className="text-[10px] font-black text-amber-300">11mm TITANIUM</span>
                                <span className="text-[7px] font-mono text-amber-200">N52 NEODYMIUM</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'motherboard' && (
                            ...
                            >
                              <div className="w-[125px] h-[125px] rounded-full border border-emerald-500/50 bg-[#011412] flex flex-col items-center justify-center text-center p-1">
                                ...
                                <span className="text-[9px] font-black text-emerald-300">H2 ANC CHIP</span>
                                <span className="text-[7px] font-mono text-emerald-400">48kHz AUDIO DSP</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'battery' && (
                            ...
                            >
                              <div className="text-center">
                                ...
                                <span className="text-[7px] font-mono text-red-300 block">3.7V LI-ION</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'sensor' && (
                            ...
                            >
                              <div className="w-full h-full rounded-full border border-purple-400/40 flex items-center justify-around p-3">
                                ...
                                <span className="text-[8px] font-black text-purple-200">DUAL MICS</span>
                                <Radio className="w-4 h-4 text-purple-300" />
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'gasket' && (
                            ...
                            >
                              <div className="w-[155px] h-[155px] rounded-full border-2 border-dashed border-pink-500/50 flex items-center justify-around p-2">
                                ...
                                <span className="text-[8px] font-black text-pink-300">GOLD CONTACTS</span>
                                <div className="w-3.5 h-3.5 rounded-full bg-amber-400 shadow-[0_0_8px_#FFB800]" />
                              </div>
                            </div>
                          )}
                      ...
                      {categoryType === 'perfumes' && (
                        <div className="w-full h-full flex items-center justify-center">
                          ...
                          {layer.type === 'case' && (
                            ...
                            >
                              <span className="text-[10px] font-black text-black">24K GOLD CAP</span>
                              <span className="text-[7px] font-mono text-black/80">MAGNETIC LOCK</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'speaker' && (
                            ...
                            >
                              ...
                              <span className="text-[8px] font-black text-black">ATOMIZER PUMP</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'gasket' && (
                            ...
                            >
                              <span className="text-[8px] font-bold text-emerald-300">AIRTIGHT SEAL</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'liquid' && (
                            ...
                            >
                              ...
                              <div className="text-center my-auto">
                                ...
                                <span className="text-[8px] font-bold text-amber-200 block">OUD & MUSK HEART</span>
                              </div>
                              <span className="text-[7px] font-mono text-amber-300">LONGEVITY 24H+</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'glass' && (
                            ...
                            >
                              ...
                              <div className="text-center">
                                <span className="text-[10px] font-black text-white">INDEXES BOTTLE</span>
                              </div>
                              <span className="text-[7px] font-mono text-purple-300">HAND-CUT GLASS</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'sensor' && (
                            ...
                            >
                              <span className="text-[9px] font-black text-pink-300">HEAVY GLASS BASE</span>
                            </div>
                          )}
                        </div>
                      )}
                            ...
                            >
                              <div className="relative w-full h-full rounded-[36px] bg-black border border-white/10 p-2.5 flex flex-col justify-between items-center overflow-hidden">
                                ...
                                <div className="text-center my-auto">
                                  ...
                                  <div className="text-[9px] font-bold text-cyan-400">INDEXES ULTRA</div>
                                </div>
                          ...
                          {layer.type === 'gasket' && (
                            ...
                            >
                              <div className="w-full h-full rounded-[38px] border-2 border-dashed border-amber-300/80 p-2 flex flex-col justify-between items-center bg-[#07050E]/80">
                                <span className="text-[8px] font-bold text-amber-300">IP68 WATERPROOF SEAL</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'motherboard' && (
                            ...
                            >
                              <div className="relative w-full h-full rounded-[34px] bg-[#02201D] border border-emerald-500/30 p-2 flex flex-col justify-between items-center">
                                <Cpu className="w-5 h-5 text-emerald-400 my-auto" />
                                <span className="text-[9px] font-black text-emerald-300">S8 DUAL-CORE</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'speaker' && (
                            ...
                            >
                              <div className="text-center my-auto">
                                ...
                                <span className="text-[9px] font-bold text-purple-200">TAPTIC ENGINE</span>
                              </div>
                            </div>
                          )}
                          ...
                          {layer.type === 'sensor' && (
                            ...
                            >
                              <div className="w-full h-full rounded-[42px] border border-white/10 p-2 flex flex-col justify-between items-center bg-black/90">
                                ...
                                <span className="text-[8px] font-mono text-zinc-400">ECG & SPO2 SENSORS</span>
                              </div>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          ...
                          {layer.type === 'glass' && (
                            ...
                            >
                              ...
                              <span className="text-[9px] font-black text-center text-sky-200 uppercase">PROTECTIVE OUTER SHELL</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'display' && (
                            ...
                            >
                              ...
                              <span className="text-[9px] font-black text-center text-purple-200">DIGITAL CONTROL MATRIX</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'case' && (
                            ...
                            >
                              <span className="text-[9px] font-black text-zinc-700">INTERNAL CHASSIS FRAME</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'gasket' && (
                            ...
                            >
                              <span className="text-[8px] font-bold text-amber-300">THERMAL COPPER SINK & SEAL</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'motherboard' && (
                            ...
                            >
                              ...
                              <span className="text-[9px] font-black text-center text-emerald-300">SMART PCB LOGIC BOARD</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'battery' && (
                            ...
                            >
                              ...
                              <span className="text-[9px] font-black text-center text-white">LITHIUM POWER PACK</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'speaker' && (
                            ...
                            >
                              <Settings className="w-5 h-5 text-purple-300 mx-auto my-auto animate-spin" style={{ animationDuration: '10s' }} />
                              <span className="text-[8px] font-black text-center text-purple-200">INTERNAL MECHANISM</span>
                            </div>
                          )}
                          ...
                          {layer.type === 'sensor' && (
                            ...
                            >
                              <span className="text-[8px] font-mono text-center text-pink-300 my-auto">REINFORCED CHASSIS BASE</span>
                            </div>
                          )}
                        </div>
                      )}
                      ...
                      {isSelected && (
                        ...
                        >
                          ...
                          <span className="text-[11px] sm:text-xs font-black">{layer.nameAr.split('(')[0]}</span>
                        </motion.div>
                      )}
                    </motion.div>
                  );
      ...
      <div className="lg:hidden relative z-30 w-full bg-black/90 border-t border-white/10 py-2.5 px-3 shrink-0">
        ...
        <div
          className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1 dir-rtl"
      ...
      <div className="relative z-30 px-4 sm:px-8 py-3 sm:py-4 bg-gradient-to-t from-black via-black/95 to-transparent backdrop-blur-2xl border-t border-white/10 flex flex-col gap-2.5 shrink-0">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex justify-between items-center text-[11px] sm:text-xs font-mono text-white/60">
            ...
            <span className="text-[#38BDF8] font-bold truncate max-w-[180px] sm:max-w-none">{currentPhase.titleAr}</span>
            <span>00:25.0s</span>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5">
              ...
              {[0.5, 1, 1.5, 2].map((speed) => (
                <button
                  ...
                  className={`px-1.5 sm:px-2 py-0.5 rounded-lg transition-all cursor-pointer ${
                    playbackSpeed === speed ? 'bg-[#38BDF8] text-black font-black' : 'text-white/70 hover:text-white'
                  }`}
                >
                  {speed}x
                </button>
          ...
          <div className="flex items-center gap-1 bg-black/60 p-1 rounded-xl border border-white/10 text-[11px] sm:text-xs font-bold">
            <button
              ...
              className={`px-2.5 py-1 rounded-lg transition-all cursor-pointer ${
                cameraView === 'orbit' ? 'bg-[#7B3FFF] text-white' : 'text-white/70 hover:text-white'
              }`}
            >
              دوران
            </button>
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-lg transition-all cursor-pointer ${
                cameraView === 'exploded' ? 'bg-[#7B3FFF] text-white' : 'text-white/70 hover:text-white'
              }`}
            >
              تفصيلي
            </button>
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-lg transition-all cursor-pointer ${
                cameraView === 'macro' ? 'bg-[#7B3FFF] text-white' : 'text-white/70 hover:text-white'
              }`}
            >
              ماكرو
            </button>
          ...
          <div className="flex items-center gap-1.5 bg-white/05 px-2.5 py-1 rounded-xl border border-white/10 text-xs">
            ...
            />
            <span className="font-mono text-[#38BDF8] text-[11px]">{Math.round(explodedFactor * 100)}%</span>
          </div>
        </div>
      </div>
    </div>
