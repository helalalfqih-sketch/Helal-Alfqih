            ...
            <div className="flex items-center justify-between rounded-xl border border-showcase-border bg-showcase-foreground/5 p-3">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="grid h-11 w-11 place-items-center rounded-lg border border-showcase-border bg-showcase-foreground/10 hover:bg-showcase-foreground/20 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                >
                ...
                <button
                  ...
                  className="grid h-11 w-11 place-items-center rounded-lg bg-primary text-primary-foreground font-bold hover:bg-primary/90 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                >
